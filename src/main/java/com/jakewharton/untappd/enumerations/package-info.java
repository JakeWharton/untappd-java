/**
 * <p>All Untappd-defined enumerations which are used both in request responses
 ...
 * the {@link com.jakewharton.untappd.UntappdEnumeration} interface in order to
 * be properly serialized.</p>
 *
 * <p>Deserialization of an enumerable value requires registration with the
 * GSON builder in the
 * {@link com.jakewharton.untappd.UntappdApiService#getGsonBuilder()} method.
 ...
 */
package com.jakewharton.untappd.enumerations;